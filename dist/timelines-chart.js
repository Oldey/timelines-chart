...
function identity$7() {
  var k = 1, tx = 0, ty = 0, sx = 1, sy = 1, transform$$1 = identity$6, // scale, translate and reflect
      x0 = null, y0, x1, y1, // clip extent
      postclip = identity$6,
      cache,
      cacheStream,
...
function interpolateTransform$1(parse, pxComma, pxParen, degParen) {
  ...
  function rotate(a, b, s, q) {
    if (a !== b) {
      if (a - b > 180) b += 360; else if (b - a > 180) a += 360; // shortest path
      q.push({i: s.push(pop(s) + "rotate(", null, degParen) - 2, x: number$4(a, b)});
    } else if (b) {
      s.push(pop(s) + "rotate(" + b + degParen);
    }
  }
  ...
  function skewX(a, b, s, q) {
    if (a !== b) {
      q.push({i: s.push(pop(s) + "skewX(", null, degParen) - 2, x: number$4(a, b)});
    } else if (b) {
      s.push(pop(s) + "skewX(" + b + degParen);
    }
  }
...
var hsl$6 = hsl$5(hue$1);
var hslLong$1 = hsl$5(nogamma$1);

function lab$4(start, end) {
  var l = nogamma$1((start = lab$3(start)).l, (end = lab$3(end)).l),
...
var hcl$6 = hcl$5(hue$1);
var hclLong$1 = hcl$5(nogamma$1);
...
var cubehelix$6 = cubehelix$5(hue$1);
...
define$3(Cubehelix$3, cubehelix$7, extend$3(Color$3, {
  brighter: function(k) {
    k = k == null ? brighter$3 : Math.pow(brighter$3, k);
...
function hue$2(a, b) {
  var d = b - a;
  return d ? linear$4(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant$11(isNaN(a) ? b : a);
}

function gamma$2(y) {
  return (y = +y) === 1 ? nogamma$2 : function(a, b) {
    return b - a ? exponential$3(a, b, y) : constant$11(isNaN(a) ? b : a);
  };
}

function nogamma$2(a, b) {
  var d = b - a;
  return d ? linear$4(a, d) : constant$11(isNaN(a) ? b : a);
}
...
function string$1(a, b) {
  ...
  while ((am = reA$2.exec(a))
    ...
    if ((am = am[0]) === (bm = bm[0])) { // numbers in a & b match
      ...
      s[++i] = null;
      q.push({i: i, x: reinterpolate$2(am, bm)});
    }
    bi = reB$2.lastIndex;
  }
...
function interpolateValue$1(a, b) {
  var t = typeof b, c;
  return b == null || t === "boolean" ? constant$11(b)
      : (t === "number" ? reinterpolate$2
...
function continuous$1(deinterpolate, reinterpolate) {
  ...
  scale.domain = function(_) {
    return arguments.length ? (domain = map$3.call(_, number$5), rescale()) : domain.slice();
  };
  ...
  scale.rangeRound = function(_) {
    return range = slice$6.call(_), interpolate$$1 = interpolateRound$1, rescale();
  };
...
function formatLocale$3(locale) {
  var group = locale.grouping && locale.thousands ? formatGroup$2(locale.grouping, locale.thousands) : identity$10,
      currency = locale.currency,
      decimal = locale.decimal,
      numerals = locale.numerals ? formatNumerals$2(locale.numerals) : identity$10,
      percent = locale.percent || "%";
...
function linear$5() {
  var scale = continuous$1(deinterpolateLinear$1, reinterpolate$2);
...
function identity$11() {
  ...
  scale.domain = scale.range = function(_) {
    return arguments.length ? (domain = map$3.call(_, number$5), scale) : domain.slice();
  };
...
function log$2() {
  var scale = continuous$1(deinterpolate$1, reinterpolate$3).domain([1, 10]),
      domain = scale.domain,
      base = 10,
      logs = logp$1(10),
      pows = powp$1(10);
...
function calendar$1(year$$1, month$$1, week, day$$1, hour$$1, minute$$1, second$$1, millisecond$$1, format) {
  ...
  scale.domain = function(_) {
    return arguments.length ? domain(map$3.call(_, number$6)) : domain().map(date$4);
  };
...
var cubehelix$10 = cubehelixLong$2(cubehelix$7(300, 0.5, 0.0), cubehelix$7(-240, 0.5, 1.0));

var warm = cubehelixLong$2(cubehelix$7(-100, 0.75, 0.35), cubehelix$7(80, 1.50, 0.8));

var cool = cubehelixLong$2(cubehelix$7(260, 0.75, 0.35), cubehelix$7(80, 1.50, 0.8));

var rainbow = cubehelix$7();
...
function identity$12(d) {
  return d;
}

function pie() {
  var value = identity$12,
      sortValues = descending$1,
      sort = null,
      startAngle = constant$13(0),
      endAngle = constant$13(tau$4),
...
function stack() {
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none$2 : typeof _ === "function" ? _ : constant$13(slice$7.call(_)), stack) : order;
  };
...
var identity$13 = new Transform(1, 0, 0);

transform$1.prototype = Transform.prototype;

function transform$1(node) {
  return node.__zoom || identity$13;
}
...
function defaultTransform() {
  return this.__zoom || identity$13;
}
  ...
  zoom.translateTo = function(selection$$1, x, y) {
    zoom.transform(selection$$1, function() {
      var e = extent.apply(this, arguments),
          t = this.__zoom,
          p = centroid(e);
      return constrain(identity$13.translate(p[0], p[1]).scale(t.k).translate(
        typeof x === "function" ? -x.apply(this, arguments) : -x,
        typeof y === "function" ? -y.apply(this, arguments) : -y
      ), e, translateExtent);
    });
...
var d3 = Object.freeze({
	...
	interpolateCubehelixDefault: cubehelix$10,
...
var slice$8 = array$6.slice;

function constant$16(x) {
  return function() {
    return x;
  };
}
...
function reinterpolateClamp$2(reinterpolate$$1) {
  return function(a, b) {
    var r = reinterpolate$$1(a = +a, b = +b);
    return function(t) { return t <= 0 ? a : t >= 1 ? b : r(t); };
  };
...
function bimap$2(domain, range, deinterpolate, reinterpolate$$1) {
  var d0 = domain[0], d1 = domain[1], r0 = range[0], r1 = range[1];
  if (d1 < d0) d0 = deinterpolate(d1, d0), r0 = reinterpolate$$1(r1, r0);
  else d0 = deinterpolate(d0, d1), r0 = reinterpolate$$1(r0, r1);
  return function(x) { return r0(d0(x)); };
...
function polymap$2(domain, range, deinterpolate, reinterpolate$$1) {
  var j = Math.min(domain.length, range.length) - 1,
      d = new Array(j),
      r = new Array(j),
      i = -1;
...
// deinterpolate(a, b)(x) takes a domain value x in [a,b] and returns the corresponding parameter t in [0,1].
// reinterpolate(a, b)(t) takes a parameter t in [0,1] and returns the corresponding domain value x in [a,b].
function continuous$2(deinterpolate, reinterpolate$$1) {
  var domain = unit$2,
      range = unit$2,
      interpolate$$1 = interpolateValue,
      clamp = false,
  ...
  function rescale() {
    piecewise$$1 = Math.min(domain.length, range.length) > 2 ? polymap$2 : bimap$2;
    output = input = null;
    return scale;
  }

  function scale(x) {
    return (output || (output = piecewise$$1(domain, range, clamp ? deinterpolateClamp$2(deinterpolate) : deinterpolate, interpolate$$1)))(+x);
  }

  scale.invert = function(y) {
    return (input || (input = piecewise$$1(range, domain, deinterpolateLinear$2, clamp ? reinterpolateClamp$2(reinterpolate$$1) : reinterpolate$$1)))(+y);
  };

  scale.domain = function(_) {
    return arguments.length ? (domain = map$4.call(_, number$7), rescale()) : domain.slice();
  };
  ...
  scale.rangeRound = function(_) {
    return range = slice$8.call(_), interpolate$$1 = interpolateRound, rescale();
  };
...
function linear$6() {
  var scale = continuous$2(deinterpolateLinear$2, reinterpolate);

  scale.copy = function() {
    return copy$2(scale, linear$6());
  };
...
var warm$2 = cubehelixLong(cubehelix(-100, 0.75, 0.35), cubehelix(80, 1.50, 0.8));

var cool$2 = cubehelixLong(cubehelix(260, 0.75, 0.35), cubehelix(80, 1.50, 0.8));

var rainbow$3 = cubehelix();

function ramp$3(range) {
  var n = range.length;
  return function(t) {
    return range[Math.max(0, Math.min(n - 1, Math.floor(t * n)))];
  };
...
ramp$3(colors$2(""));

var magma$2 = ramp$3(colors$2(""));

var inferno$2 = ramp$3(colors$2(""));

var plasma$2 = ramp$3(colors$2(""));
...
var gradient = Kapsule({
    props: {
        ...
        colorScale: { default: linear$6().range(['black', 'white']) },
    ...
    update: function update(state) {
        ...
        var stopsScale = linear$6().domain([0, 100]).range(state.colorScale.domain());
